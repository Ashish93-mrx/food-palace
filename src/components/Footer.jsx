const Footer = () => {
    return (
      <footer className="bg-orange-500 text-white py-6 mt-10 sticky buttom-0 z-50">
        ...
        <p className="text-center text-xs mt-4">&copy; {new Date().getFullYear()} FoodZone. All rights reserved.</p>
      </footer>
